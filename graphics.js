...
(function() {
  var att_lined_style, bot_points, bot_size, bot_style, cell_size, clear_style, command_scrim_points, command_size, digit_graphics, exit_text_style, filled_style, g, hr3, inner_command_size, lined_style, menu_text_spacing, menu_text_style, obstacle_cell_style, pixlined_style, program_cell_style, renderNumber, rr3, setStyle, thick_lined_style;
  ...
  g.renderBot = function(ctx, x, y, dir) {
    var bp;
    bp = bot_points;
    ctx.save();
    ctx.translate(x, y);
